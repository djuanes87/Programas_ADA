...
package Latest_Msgs is
	...
	type Status_Time_Type is (Back, Present, Future);
	
	type List_Protected_Msgs is limited private;
	
	procedure Obtener_Seq_N (List : in out List_Protected_Msgs; EP_H_Creat : in LLU. End_Point_Type; S : in out Types.Seq_N_T);		
	procedure Comprobar_Message_Repetido(List: in out List_Protected_Msgs; EP_H_Creat: in LLU.End_Point_Type; S: in out Types.Seq_N_T ; Mess : in CM.Message_Type;  Estado: in out Status_Time_Type);
...
private
	...
	protected type List_Protected_Msgs is
		...
		procedure Obtener_Seq_N (EP_H_Creat : in LLU. End_Point_Type; S :in  out Types.Seq_N_T);
		procedure Comprobar_Message_Repetido(EP_H_Creat: in LLU.End_Point_Type; S: in out Types.Seq_N_T ; Mess : in CM.Message_Type;  Estado: in out Status_Time_Type);
