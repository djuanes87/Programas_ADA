...
package Neighbors is
	...
	procedure Crear_Destinations (Vecinos: in out List_Protected_Neighbors; Cont: in Integer; EP: out LLU.End_Point_Type);
...
private
	...
	protected type List_Protected_Neighbors is
		...
		procedure Crear_Destinations (Cont: in Integer; EP: out LLU.End_Point_Type);
